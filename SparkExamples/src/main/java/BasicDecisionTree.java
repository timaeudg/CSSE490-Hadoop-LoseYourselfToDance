 ...
 */
public final class BasicDecisionTree {
    ...
    public static void main(String[] args) {
        ...
        impurity = "variance";
        final DecisionTreeModel regressionModel = DecisionTree.trainRegressor(data, categoricalFeaturesInfo, impurity,
                maxDepth, maxBins);
        ...
        Double trainMSE = regressorPredictionAndLabel.map(new Function<Tuple2<Double, Double>, Double>() {

            public Double call(Tuple2<Double, Double> pl) throws Exception {
